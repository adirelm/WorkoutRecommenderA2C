...
| TR10 | Transcript / grading_hints | ANALYSIS SECTION (§7.6) matters — graphs + comparison beyond "does it run". | docs/ANALYSIS.md + results/comparison/*.png | test_analysis_artifacts_exist | MUST |
